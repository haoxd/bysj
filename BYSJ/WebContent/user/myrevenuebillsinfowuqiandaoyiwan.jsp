...
<meta charset="utf-8">
<title>E理财MY【收入信息/5000-10000】</title>
		...
		<div class="head-body-wrap">
			<div class="head-body clearfix">
				<div class="fund-logo-wrap">
					...
					<div class="fund-slogan">E理财家庭理财网 <a href="http://localhost:8080/BYSJ/user/addmyshouru.jsp" target="_blank" title="新增收入账单" style="color: orange;">[我的收入/5Q-1W账单]</a></div>
				</div>
				...
				<c:choose>
<c:when test="${empty userToRevenueBillsWuQian_YiWan}">
<p align="center" ><a style="color: orange; " href="http://localhost:8080/BYSJ/user/addmyshouru.jsp" target="_blank"><font size="5px">没有任何关于您的5Q-1W账单，请添加</font></a></p>
</c:when>
	...
	<div class="main-wide-wrap" data-sk-area="FundList-ska">
	 ...
	 <c:forEach items="${userToRevenueBillsWuQian_YiWan}" var="userToRevenueBills" > 
				...
				<ul class="clearfix">
					...
					<span class="product-property-name">账单名称</span>
						...
						<a href="http://localhost:8080/BYSJ/revenuebills/queryUserRevenusBillsinfo?rid=${userToRevenueBills.revenueBillsID }" target="_blank"title="编辑账单信息">${userToRevenueBills.revenueBillsName }</a>
						</span>
						</p>
					</li>
	...
	<!--###############################################  -->	
		...
		<c:choose>
      	...
      	<c:otherwise>
      		<a  style="color: orange;" href="/BYSJ/revenuebills/queryUserRevenuebillsThisWuQian_YiW?pageNo=1&&uid=${user.userID}">首页</a>&nbsp;
      		<a   style="color: orange;"href="/BYSJ/revenuebills/queryUserRevenuebillsThisWuQian_YiW?pageNo=${pb.pageNo-1}&&uid=${user.userID}">上一页</a>&nbsp;
      	</c:otherwise>
      </c:choose>
    	...
    	<c:choose>
    		...
    		<c:otherwise>
    			<a  style="color: orange;" href="/BYSJ/revenuebills/queryUserRevenuebillsThisWuQian_YiW?pageNo=${pb.pageNo+1}&&uid=${user.userID}">下一页</a>&nbsp;
    			<a   style="color: orange;" href="/BYSJ/revenuebills/queryUserRevenuebillsThisWuQian_YiW?pageNo=${pb.totalPage}&&uid=${user.userID}">尾页</a>&nbsp;
    		</c:otherwise>
    	</c:choose>
