 ...
 <div class="boxcenter" style="overflow:visible;">
    <div class="yxj_zhuce" style="overflow:visible;">
       ...
       <div class="yxj_zc_con" style="overflow:visible;height: 450px;">
          ...
          <div class="yxj_zx01">
             <h1>编辑${queryRevenueBills.revenueBillsName}账单：</h1>

        
             <span style="color: #ff0000;font-size: 14px;" id="message"></span>
          </div>
        <form  action="/BYSJ/revenuebills/updateUserRevenueBillsInfo" method="post" class="yxj_zx02" style="overflow:visible; height:400px;" onsubmit="return expertSent()">
           
             <div class="yxj_zx02L" style="overflow:visible;">
             	 <input type="hidden" name="revenueBillsID" value="${queryRevenueBills.revenueBillsID}">
             	 <input type="hidden" name="uid" value="${user.userID}">
                 <h1><p>账单名称</p><span> 3大于字数小于8</span></h1>
                  <input type="text" id="revenueBillsName" name="revenueBillsName" placeholder=" ${queryRevenueBills.revenueBillsName}">
                  <h1><p>账单类型</p><span>工资/外快/贺礼/理财</span></h1>
                  <input type="text" id="revenueBillsState" name="revenueBillsState" placeholder="${queryRevenueBills.revenueBillsState}">
                  <h1><p>收入金额</p><span>RMB</span></h1>
                  <input type="text" id="revenueBillsMoney" name="revenueBillsMoney" placeholder="${queryRevenueBills.revenueBillsMoney}">
                  
             </div>
             <div class="yxj_zx02R" style="overflow:visible;">
                
				<h1><p>账单内容</p><span>账单详情</span></h1>
				<textarea rows="5" cols="19" id="revenueBillsBody" name="revenueBillsBody"  style="resize: none; height:200px; width:320px; font-family:'黑体'; " placeholder="${queryRevenueBills.revenueBillsBody}" ></textarea>		
