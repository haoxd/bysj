 ...
 <div class="boxcenter" style="overflow:visible;">
    <div class="yxj_zhuce" style="overflow:visible;">
       ...
       <div class="yxj_zc_con" style="overflow:visible;height: 450px;">
        ...
        <form  action="/BYSJ/spendingbills/addUserSpendingBills" method="post" class="yxj_zx02" style="overflow:visible; height:400px;" onsubmit="return expertSent()">
           
             <div class="yxj_zx02L" style="overflow:visible;">
              <input type="hidden" name="spendingBills_User" value="${user.userID}">
                 <h1><p>账单名称</p><span> 3大于字数小于8</span></h1>
                  <input type="text" id="spendingBillsName" name="spendingBillsName" placeholder=" 请输入账单名称">
                  <h1><p>账单类型</p><span>吃饭/旅游/逛街/其他</span></h1>
                  <input type="text" id="spendingBillsState" name="spendingBillsState" placeholder="吃饭/旅游/逛街/其他">
                  <h1><p>支出金额</p><span>RMB</span></h1>
                  <input type="text" id="spendingBillsMoney" name="spendingBillsMoney" placeholder="请输入金额,必须是数字">
                  
             </div>
             <div class="yxj_zx02R" style="overflow:visible;">
                
				<h1><p>账单内容</p><span>账单详情</span></h1>
				<textarea rows="5" cols="19" id="spendingBillsBody" name="spendingBillsBody"  style="resize: none; height:200px; width:320px; font-family:'黑体'; " placeholder="${queryUser.userText }" ></textarea>		
