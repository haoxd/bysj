     ...
     <div style="height:700px; width:615px; background:#fff; margin:39px auto;">
	          <div class="yxj_yjfk">
                 <div class="yxj_line3" style="background:#fac53b;"></div>
                  <div class="yxj_zx01">
					<h1>修改密码</h1>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<h2>${loginFailInfoMessage }</h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;				
				  </div>
				 
				<p align="center">  <span style="color: #ff0000;font-size: 14px; " id="message" ></span></p>
                  <div class="signup_check">
                  <form action="/BYSJ/user/updateUserPassword" method="post"   onsubmit="return expertSent()"> 
                     <table class="signup_check2">
                      ...
                      <tr>
                          ...
                          <td><input type="hidden" id="thismypassword"  name="thismypassword" value="${user.userPassword}"></td>
                       </tr>
                        <tr>
                          <td>旧密码</td>
