     ...
     <div style="height:700px; width:615px; background:#fff; margin:39px auto;">
	          <div class="yxj_yjfk">
                 <div class="yxj_line3" style="background:#fac53b;"></div>
                  <div class="yxj_zx01">
					<h1>【${ queryMylife.mylifeTitle}】信息如下</h1>
				...
				<p align="center">  <span style="color: #ff0000;font-size: 14px; " id="message" ></span></p>
                  ...
                  <form action="/BYSJ/mylife/updateUserMylifeInfo" method="post"   onsubmit="return expertSent()"> 
                     <table class="signup_check2">
                      ...
                      <tr>
                          ...
                          <td><input type="hidden" name="mylifeID" value="${queryMylife.mylifeID}"></td>
                       </tr>
                        <tr>
                          <td>标题</td>
                          <td><input id="title" type="text" name="mylifeTitle" value="${queryMylife.mylifeTitle}" /></td>
                       </tr>
                       <tr>
                          <td>地点</td>
                          <td><input id="name" type="text" name="mylifeCreateCity"  value="${queryMylife.mylifeCreateCity}" /></td>
                       </tr>
                       <tr>
                          <td>时间</td>
                          <td><input id="phone" type="text" name="mylifeCreateTime" value="${queryMylife.mylifeCreateTime}"onfocus="HS_setDate(this)"/></td>
                       </tr>
                        <tr>
                          <td>心情</td>
                         <td>
                      ...
                      <option value="高兴">高兴</option>
                       ...
                       <tr>
                          <td>日记</td>
                          <td>
                         <textarea rows="5" cols="19" id="text" name="mylifeLog"  style="resize: none; height:200px; width:450px; font-family:'黑体'; " placeholder="${queryMylife.mylifeLog}" ></textarea>		
                          </td>
                       </tr>
                       <tr>
                          <td></td>
                          <td align="right">                          
                          <input type="submit" value="保存" class="yxj_yjtj"/>
